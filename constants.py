...
if IS_ORANGE_BOT:
    INCHES_TO_TICKS = 192 #larger numbers = longer drive
    lAdjust =  0.86 #.875 # 1.12 # .99  # adjust left wheel counter to fix drift; Larger number makes the robot drive left...?
else: # Blue Bot
    INCHES_TO_TICKS = 197
